...
// This is a famous person quote:
var famousquote = "Success is not final, failure is not fatal: It is the courage to continue that counts.";
var writer = "Winston Churchill once said";
console.log("".concat(writer, ", \"").concat(famousquote, "\""));
// Here is Personal Message with person’s name:
var MyName = "Hassan";
